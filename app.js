(function () {
  ...
  document.addEventListener("click", (event) => {
    ...
    if (action === "toggle-flash") {
      ...
      front?.querySelector(".flip-button")?.toggleAttribute("tabindex", state.flashAnswerVisible);
      back?.querySelector(".flip-button")?.toggleAttribute("tabindex", !state.flashAnswerVisible);
    }
